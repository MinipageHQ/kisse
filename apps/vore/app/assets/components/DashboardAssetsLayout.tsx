...
const DashboardAssetsLayout: BlitzLayout<{
  ...
  return (<DashboardLayout title={title}>
    ...
    <Alert title="You need to verify your identity before you can sell items." variant="outline">
      To comply with regulations, we need to verify your identity and bank information via our partner, Stripe, before you can sell items on Saltana.
    </Alert>
    <div className="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
      ...
      <div className="mt-4 flex sm:mt-0 sm:ml-4">
        ...
        <Link href={Routes.AssetsPage({ linkQueries: ['new'] })} passHref>
