...
var exports = {};
exports.id = 9338;
exports.ids = [9338,8999,4331,8987,6923,5112,5682,2840,9592,2090,2202,1995,7062,9710,3632,2813,7089,1716,4923,5026,6950];
exports.modules = {
...
const DeleteTransaction = zod__WEBPACK_IMPORTED_MODULE_3__.z.object({
  id: zod__WEBPACK_IMPORTED_MODULE_3__.z.string().cuid()
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.zod(DeleteTransaction), next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.authorize(), async ({
  id
}) => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const transaction = await db__WEBPACK_IMPORTED_MODULE_2__.default.transaction.deleteMany({
    where: {
      id
    }
  });
...
var __webpack_exports__ = (__webpack_exec__(4941));
