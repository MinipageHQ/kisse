...
var exports = {};
exports.id = 1202;
exports.ids = [1202,8999,4331,8987,6923,5112,5682,2840,9592,2090,2202,1995,7062,9710,3632,2813,7089,1716,4923,5026,6950];
exports.modules = {
...
const CreateDocument = zod__WEBPACK_IMPORTED_MODULE_3__.z.object({
  name: zod__WEBPACK_IMPORTED_MODULE_3__.z.string(),
  organization: zod__WEBPACK_IMPORTED_MODULE_3__.z.number()
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.zod(CreateDocument), next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.authorize(), async input => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const document = await db__WEBPACK_IMPORTED_MODULE_2__.default.document.create({
    data: input
  });
  return document;
}), {
  "resolverName": "createDocument",
  "resolverType": "mutation",
  "routePath": "/api/rpc/createDocument"
}));
...
var __webpack_exports__ = (__webpack_exec__(2332));
