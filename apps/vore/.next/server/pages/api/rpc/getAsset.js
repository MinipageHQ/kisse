...
var exports = {};
exports.id = 9487;
exports.ids = [9487,8999,4331,8987,6923,5112,5682,2840,9592,2090,2202,1995,7062,9710,3632,2813,7089,1716,4923,5026,6950];
exports.modules = {
...
const GetAsset = zod__WEBPACK_IMPORTED_MODULE_4__.z.object({
  // This accepts type of undefined, but is required at runtime
  id: zod__WEBPACK_IMPORTED_MODULE_4__.z.string().cuid()
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.zod(GetAsset), next_stdlib_server__WEBPACK_IMPORTED_MODULE_2__.resolver.authorize(), async ({
  id
}) => {
  // TODO: in multi-tenant app, you must add validation to ensure correct tenant
  const asset = await db__WEBPACK_IMPORTED_MODULE_3__.default.asset.findFirst({
    where: {
      id
    }
  });
  if (!asset) throw new next_stdlib__WEBPACK_IMPORTED_MODULE_1__.NotFoundError();
  return asset;
}), {
  "resolverName": "getAsset",
  "resolverType": "query",
  "routePath": "/api/rpc/getAsset"
}));
