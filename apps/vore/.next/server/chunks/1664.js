...
var _router = _interopRequireWildcard(__webpack_require__(1063));
...
function useRouterQuery() {
  ...
  const query = _react.default.useMemo(() => (0, _router).extractQueryFromAsPath(router.asPath), [router.asPath]);
...
var _lodashFrompairs = _interopRequireDefault(__webpack_require__(7458));

var _superjson = __webpack_require__(5071);
...
class Router {
  constructor(pathname1, query1, as1, {
    ...
    this.query = query1;
    this.params = extractRouterParams(query1, extractQueryFromAsPath(as1)); // if auto prerendered and dynamic route wait to update asPath
  ...
  */
  ...
  _getServerData(dataHref) {
    const {
      href: resourceKey
    } = new URL(dataHref, window.location.href); // @ts-ignore -- blitzjs
