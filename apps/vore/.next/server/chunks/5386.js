...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_data_client__WEBPACK_IMPORTED_MODULE_0__.buildRpcResolver)(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.pipe(next_stdlib_server__WEBPACK_IMPORTED_MODULE_1__.resolver.authorize(), async ({
  ...
  const {
    ...
    skip,
    take,
    count: () => db__WEBPACK_IMPORTED_MODULE_2__.default.transaction.count({
      where
    }),
    query: paginateArgs => db__WEBPACK_IMPORTED_MODULE_2__.default.transaction.findMany(_objectSpread(_objectSpread({}, paginateArgs), {}, {
      where,
      orderBy
    }))
  });
  ...
  "resolverName": "getTransactions",
  "resolverType": "query",
  "routePath": "/api/rpc/getTransactions"
}));
