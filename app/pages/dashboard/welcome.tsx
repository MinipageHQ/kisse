  ...
  return (
    <>
      ...
      <div className="max-w-md mx-auto">
        ...
        <h1 className="text-3xl text-slate-800 font-bold mb-6">What's next? ✨</h1>
        {/* Form */}
        <form>
          ...
          <div className="flex items-center justify-between">
            <a className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto">Next Step -&gt;</a>
          </div>
        </form>
...
const DashboardWelcomePage: BlitzPage = () => {
  return (
    <div>
...
DashboardWelcomePage.authenticate = true
DashboardWelcomePage.getLayout = (page) => <DashboardCreatorSettingsLayout>{page}</DashboardCreatorSettingsLayout>
