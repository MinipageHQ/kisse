...
import DiscoverWorkflows from "app/workflows/components/DiscoverWorkflows"
                ...
                {({ selected, active }) => (
                  <div className="flex flex-col">
                    <div className="flex justify-between">
                      <p className={selected ? "font-semibold" : "font-normal"}>{type.name}</p>
                      {selected ? (
        ...
        {links.data.length > 0 && (
          <div className="mt-10 sm:hidden">
            ...
            <ul role="list" className="mt-3 border-t border-gray-200 divide-y divide-gray-100">
              {links.data.map((link) => (
                <li key={link.id}>
                  <CreatorDashboardLinksLink href={`?link=${link.id}`} passHref shallow>
                    <a
                      href="#"
                      ...
                      <span className="flex items-center truncate space-x-3">
                        ...
                        <span className="font-medium truncate text-sm leading-6">
                          ...
                          <span className="truncate font-normal text-gray-500">
                            {link.destination || link.linkType}
                          </span>
                        </span>
                      </span>
                      <ChevronRightIcon
                    ...
                    <tr key={link.id}>
                      ...
                      <td className="px-6 py-3 text-sm text-gray-500 font-medium">
                        <div className="flex items-center space-x-2">
                          <div className="flex flex-shrink-0 -space-x-1">sds</div>
