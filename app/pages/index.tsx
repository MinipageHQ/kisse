...
import heroImage from "public/marketing-images/hero-image.png"
import easyToUse from "public/marketing-images/easy-to-use.png"
import logoDark from "public/marketing-images/logo-dark.png"
      ...
      <div className="">
        <section className="relative pb-20">
          <nav className="flex justify-between items-center py-8 px-4 xl:px-10 ">
            <a className="text-lg font-semibold" href="https://www.saltana.com">
              <Image src={logoDark} alt="Saltana" layout="fixed" />
            </a>
          ...
          <div className="relative container pt-12 px-4 mx-auto text-center">
            <span className="text-blue-400 font-semibold">For the creators, by the creators</span>
            ...
            <p className="max-w-3xl mx-auto mb-8 lg:mb-12 text-xl text-gray-500">
              Creator economy is the future, get ready to seize it! Saltana provides creators with
              easy checkouts and hassle-free delivery.
            </p>
            <a
          ...
          <div className="container px-4 mx-auto">
            <div className="relative max-w-2xl mx-auto">
              ...
              <div className="relative z-10 lg:py-10">
                <p className="mb-10 text-2xl leading-loose">
                  Saltana helps you create branded checkout experiences just for the purpose of
                  selling digital products online. Turn your side hustle into a business with
                  end-to-end sales process from hosted payment pages, checkout, automated promotions
                  to delivery, and so much more.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="relative w-full md:w-1/2 px-4 pb-20 lg:pb-0">
                <div className="lg:ml-auto max-w-md">
                  ...
                  <p className="mb-6 lg:mb-10 text-xl text-gray-500">
                    Whether you&rsquo;re selling ebooks, software, online courses, or other digital
                    products, Saltana&rsquo;s full-service product platform makes it easy to sell
                    more, stay lean, and compete big.
                  </p>
                  <div className="mb-10 border rounded-lg">
                    <div className="flex p-4 border-b">
                      ...
                      <h3 className="font-semibold font-heading">Modern, responsive checkout</h3>
                    </div>
                    <div className="flex p-4 border-b">
                      <svg
                        className="mr-4 mt-1"
                      ...
                      <h3 className="font-semibold font-heading">Fast &amp; secure delivery</h3>
                    </div>
                    <div className="flex p-4">
                      ...
                      <h3 className="font-semibold font-heading">Full product reports</h3>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative flex flex-wrap items-center -mx-4">
              <div className="relative w-full lg:w-1/2 px-4 pb-12 lg:pb-0">
                <div className="max-w-md">
                  <h2 className="mb-6 lg:mb-10 text-4xl font-semibold font-heading">Easy to use</h2>
                  <p className="mb-6 lg:mb-10 text-xl text-gray-500">
                    Saltana is a one-stop platform for creators to sell digital products from
                    selling, delivering, marketing to analytics. A simple and powerful solution.
                  </p>
                  <div className="mb-10 border rounded-lg">
                    <div className="flex p-4 border-b">
                      <svg
                      ...
                      <h3 className="font-semibold font-heading">Discount &amp; promo codes</h3>
                    </div>
                    <div className="flex p-4 border-b">
                      <svg
                        className="mr-4 mt-1"
                      ...
                      <h3 className="font-semibold font-heading">Embedded buttons</h3>
                    </div>
                    <div className="flex p-4">
                      <svg
                        className="mr-4 mt-1"
                      ...
                      <h3 className="font-semibold font-heading">Income analytics</h3>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap -mx-3">
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-teal-400 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Sell</h3>
                    <p className="text-base text-gray-500">
                      You can use our shopping cart and embed button on your website or you can
                      direct your customers to our hosted payment page.
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-blue-400 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Deliver</h3>
                    <p className="text-base text-gray-500">
                      Sell whatever you want, wherever you want and to whomever you want and
                      we&apos;ll deliver your downloadable products fast and safe.
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-red-400 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Market</h3>
                    <p className="text-base text-gray-500">
                      Saltana has all kinds of marketing automations you can think of. Email
                      marketing automation, coupon codes, upsells, affiliates, etc.
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 lg:mb-0">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-orange-400 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Secure</h3>
                    <p className="text-base text-gray-500">
                      Saltana protects your intellectual property and customers&apos;l data with
                      powerful and reliable management tools.
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 lg:mb-0">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-yellow-400 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Customize</h3>
                    <p className="text-base text-gray-500">
                      With Saltana, creators can customize every step of the checkout experience.
                      Custom branding, email templates, embedded buttons...
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 lg:mb-0">
                <div className="p-6 md:p-8 h-full border rounded-lg hover:bg-white hover:shadow-xl hover:border-transparent cursor-pointer">
                  <span className="flex-shrink-0 flex items-center justify-center w-16 h-16 mb-8 md:mb-12 bg-gray-900 rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                  ...
                  <div>
                    <h3 className="mb-4 text-2xl font-semibold font-heading">Analyze</h3>
                    <p className="text-base text-gray-500">
                      Optimize your sales process with top-notch dashboards and boost your revenue
                      with Saltana.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-20">
          <div className="container px-4 mx-auto">
            <h2 className="mb-8 md:mb-16 text-5xl lg:text-6xl font-semibold font-heading">
              Sell quickly &amp; scale efficiently
            </h2>
            <div className="flex flex-wrap items-center">
              <div className="inline-block max-w-xl mb-6 md:mb-0">
                <p className="text-xl text-gray-500">
                  Saltana is super simple. You just focus on creating digital products, start
                  selling in seconds. Your customers will have a world class checkout experience.
                </p>
              </div>
              <a
            ...
            <div className="pb-6 lg:pb-10 border-b border-gray-100">
              <div className="flex flex-wrap items-start justify-between">
                <div className="w-full lg:w-1/5 mb-6 lg:mb-0">
                  ...
                  >
                    <Image src={logoDark} alt="" layout="responsive" />
                  </a>
                </div>
              </div>
            </div>
            <div>
              <div className="flex flex-wrap justify-between items-center">
                <p className="text-sm text-gray-500 mt-8">
                  All rights reserved &copy; Copyright 2022 hey@saltana.com
                </p>
...
MarketingHome.getLayout = (page) => <Layout title="Home">{page}</Layout>
