    ...
    <main className="max-w-3xl mx-auto pt-5 pb-12 px-4 lg:pb-16">
      ...
      {link.data?.linkType === "asset" && (
        <>
          ...
          <div className="mb-4">
            <AssetCategorySelector register={register} control={control} setValue={setValue} />
          </div>

          <div className="mb-4">
            <AssetTypeSelector register={register} control={control} setValue={setValue} />
          </div>
          <div className="mb-4">
            <label htmlFor="asset.name" className="block text-sm font-medium text-gray-700">
              Price
      ...
      <div className="mb-4">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Lorem ipsum dolor sit amet consectetur adipisicing elit quam corrupti consectetur. c
        </p>
        <div className="mt-3">
      ...
      {link.data?.linkType !== "asset" && link.data?.destination && (
        <div className="space-y-6">
          <div>
            <label htmlFor="link.destination" className="block text-sm font-medium text-gray-700">
              Destination
            </label>
            <div className="mt-1">
              <input
