...
function NewPicker() {
  ...
  const [selectedSecondaryColor, setSelectedSecondaryColor] = React.useState(null)
  ...
  return (
    <div className="App">
      ...
      <pre className="code">{JSON.stringify(selectedPrimrayColor, null, 2)}</pre>
    </div>
  )
}
      ...
      <div className="space-y-8 divide-y divide-gray-200">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Assets you selected are combined inside the checkout form in your link.
          </p>
