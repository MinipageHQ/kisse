...
import getExternalUrlDetails from "../queries/getExternalUrlDetails"
...
export default function DashboardExternalUrlPreview({ targetUrl }: { targetUrl: string }) {
  const [externalUrl, { isFetched }] = useQuery(getExternalUrlDetails, { targetUrl }, {})
