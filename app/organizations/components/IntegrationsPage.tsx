              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">Google Analytics</h3>
                  </header>
                  <div className="text-sm">
                    Use Google Analytics in your Saltana space, complete with ecommerce integrations
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">Zapier</h3>
                  </header>
                  <div className="text-sm">
                    Integrate hundreds of services into your Saltana space using Zapier&apos;s
                    powerful features.
                  </div>
                </div>
                {/* Card footer */}
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">Notion</h3>
                  </header>
                  <div className="text-sm">
                    Set defaults for your Notion links, customize style, privacy and more
                  </div>
                </div>
                {/* Card footer */}
                <footer className="mt-4">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-slate-200">
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header>
                    <h3 className="text-lg text-slate-800 font-semibold mb-1">Webhooks</h3>
                  </header>
                </div>
                {/* Card footer */}
